...
import {
  TEXT_PRESETS as ALL_TEXT_PRESETS,
...
const ANIMATED_TEXT_LAYERS: Array<{
...
}> = [
  {
    ...
    label: "Rise Title",
    emoji: "⬆️",
    description: "Bold title that rises into frame",
    text: "YOUR TITLE",
    clipColor: "#8b5cf6",
    animationIn: "slideUp",
    animationOut: "fade",
  ...
  },
  {
    ...
    emoji: "💬",
    description: "Italic serif quote that gently floats",
  ...
  },
  {
    ...
    label: "Neon Slide",
    emoji: "🌈",
    description: "Neon glow text slides in from left",
    text: "NEON",
    clipColor: "#ec4899",
    animationIn: "slideLeft",
    animationOut: "fade",
    motionPath: "slide-in-l",
    x: 0.05,
    y: 0.38,
    w: 0.9,
    h: 0.15,
  ...
  {
    key: "atl-lower-drift",
    label: "Lower-Third Drift",
    emoji: "📺",
    description: "Lower-third caption that drifts right",
    text: "Lower Third",
    clipColor: "#3b82f6",
    animationIn: "slideLeft",
    animationOut: "fade",
  ...
  },
  {
    ...
    label: "Retro Shake",
    emoji: "📼",
    description: "Bold retro text with a shake motion",
    text: "RETRO",
    clipColor: "#f97316",
    animationIn: "zoom",
    animationOut: "fade",
  ...
  },
  {
    ...
    emoji: "🎬",
    description: "Wide-letter cinematic title that arcs in",
    text: "DREAMSCAPE",
    clipColor: "#06b6d4",
    animationIn: "fade",
    animationOut: "fade",
  ...
  },
  {
    ...
    label: "Luxury Gold",
    emoji: "✨",
    description: "Elegant gold serif that rises softly",
    text: "LUXURY",
    clipColor: "#f59e0b",
    animationIn: "fade",
    animationOut: "fade",
  ...
  {
    key: "atl-gradient-arc",
    label: "Gradient Arc",
    emoji: "🌊",
    description: "Gradient headline following an arc path",
    text: "GRADIENT",
    clipColor: "#8b5cf6",
    animationIn: "zoom",
    animationOut: "fade",
  ...
  },
  {
    ...
    label: "Sports Bounce",
    emoji: "🏆",
    description: "Impact sports text that bounces in",
    text: "CHAMPION",
    clipColor: "#f43f5e",
    animationIn: "zoom",
    animationOut: "fade",
  ...
  },
  {
    ...
    label: "Social Pop",
    emoji: "📱",
    description: "Social-media gradient that zooms and pulses",
    text: "TRENDING",
    clipColor: "#ec4899",
    animationIn: "zoom",
    animationOut: "fade",
    motionPath: "zoom-pulse",
    x: 0.05,
    y: 0.38,
    w: 0.9,
    h: 0.15,
  ...
  {
    key: "atl-hipop-spiral",
    label: "Hip-Hop Spiral",
    emoji: "🎤",
    description: "Bold hip-hop text with spiral entrance",
    text: "FIRE",
    clipColor: "#f97316",
    animationIn: "zoom",
    animationOut: "fade",
    ...
    style: {
      ...
      color: "#ffffff",
      align: "center",
      stroke: { enabled: true, color: "#ff0000", width: 6 },
    },
  },
  {
    key: "atl-pendulum-count",
    label: "Pendulum Counter",
    emoji: "⏱️",
    description: "Monospace counter with pendulum sway",
    text: "00:00",
    clipColor: "#10b981",
    animationIn: "fade",
    animationOut: "fade",
    ...
    style: {
      ...
      color: "#00ff88",
      align: "center",
      glow: { enabled: true, color: "#00ff88", blur: 14, intensity: 2 },
    },
  },
  {
    key: "atl-vintage-drift",
    label: "Vintage Drift",
    emoji: "🎞️",
    description: "Sepia vintage text drifting across",
    text: "REMEMBER",
    clipColor: "#a16207",
    animationIn: "fade",
    animationOut: "fade",
  ...
  {
    key: "atl-hand-float",
    label: "Handwrite Float",
    emoji: "✍️",
    description: "Handwritten script that floats and fades",
  ...
  },
  {
    ...
    label: "Tech Slide",
    emoji: "💻",
    description: "Glowing tech text that slides from right",
    text: "> LOADING...",
    clipColor: "#06b6d4",
    animationIn: "slideLeft",
    animationOut: "fade",
    motionPath: "slide-in-r",
    x: 0.05,
    y: 0.4,
    w: 0.9,
    h: 0.12,
  ...
  {
    key: "atl-minimalist",
    label: "Minimalist Float",
    emoji: "◻️",
    description: "Ultra-thin minimalist text floating gently",
    text: "less is more",
    clipColor: "#64748b",
    animationIn: "fade",
    animationOut: "fade",
  ...
  {
    key: "atl-caption-rise",
    label: "Caption Rise",
    emoji: "📖",
    description: "Clean subtitle that rises to bottom third",
  ...
  },
  {
    ...
    label: "Neon Circle",
    emoji: "🔵",
    description: "Neon text that traces a circular path",
    text: "LOOP",
    clipColor: "#a855f7",
    animationIn: "fade",
    animationOut: "fade",
    ...
    style: {
      ...
      color: "#a855f7",
      align: "center",
      glow: { enabled: true, color: "#a855f7", blur: 16, intensity: 3 },
    },
  },
  {
    key: "atl-figure8-title",
    label: "Figure-8 Title",
    emoji: "∞",
    description: "Bold title that traces a figure-8 path",
    text: "INFINITE",
    clipColor: "#f59e0b",
    animationIn: "fade",
    animationOut: "fade",
  ...
  },
  {
    ...
    emoji: "🔏",
    description: "Subtle drifting watermark overlay",
    text: "© yourbrand",
    clipColor: "#64748b",
    animationIn: "fade",
    animationOut: "fade",
...
function EffectsGroup({
  ...
  return (
    <div className="border border-border/40 rounded-md overflow-visible">
      <button
      ...
      >
        ...
        <span className="text-[10px] uppercase tracking-widest font-medium text-muted-foreground flex-1">
          {title}
        </span>
      </button>
      {open && (
        <div className="p-2 space-y-1.5 overflow-y-auto max-h-64">
          {children}
        </div>
      )}
    </div>
...
function EffectsTabContent({
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 overflow-y-auto p-2 space-y-2">
      {/* ── Animated Particles ─── */}
      <EffectsGroup title={`✨ Particles (${PARTICLE_LIBRARY.length})`}>
        <p className="text-[9px] text-muted-foreground">
          Animated overlays — snow, fire, confetti and more. Tune in the
          inspector.
        </p>
      ...
      <EffectsGroup title={`🌊 Waves (${WAVE_LIBRARY.length})`}>
        <p className="text-[9px] text-muted-foreground">
          Animated canvas waves. Colors & speed tunable in inspector.
        </p>
        <div className="grid grid-cols-5 gap-1">
          {WAVE_LIBRARY.map((w) => (
            <button
          ...
          {GRADIENT_PRESETS.map((g) => {
            ...
            const bg =
              g.kind === "radial"
                ...
                : g.kind === "conic"
                  ? `conic-gradient(from 0deg, ${stopStr})`
      ...
      <EffectsGroup title="🎵 Visualizers (Audio-React)">
        <div className="grid grid-cols-5 gap-1">
          {VISUALIZER_PRESETS.map((v) => (
            ...
            >
              <span style={{ color: v.color }} className="text-xs font-bold">
                {v.icon}
              </span>
      ...
      <EffectsGroup title="🔧 Adjustment Layers">
        <p className="text-[9px] text-muted-foreground">
          Non-destructive adjustment layers that affect clips beneath them.
        </p>
        <Button
          variant="outline"
          size="sm"
        ...
        <Button
          ...
          onClick={() => {
            const preset =
              SPECIAL_LAYERS.find((s) => s.key === "tealOrange") ??
              SPECIAL_LAYERS[0];
            dispatch({
              type: "ADD_CLIP",
              payload: makeClip({
      ...
      <EffectsGroup
        title={`✍️ Animated Text (${ANIMATED_TEXT_LAYERS.length})`}
        defaultOpen={false}
      >
        <p className="text-[9px] text-muted-foreground">
          One click adds styled text with motion keyframes. Edit content in
          inspector.
        </p>
            ...
            <button
              ...
              onClick={() => {
                ...
                if (atl.motionPath !== "none") {
                  ...
                  buildMotionKeyframes(atl.motionPath, snapshot).forEach(
                    ({ property, time, value, easing }) => {
                      dispatch({
                        type: "ADD_KEYFRAME",
                        payload: { clipId, property, time, value, easing },
                      });
                    },
                  );
                }
      ...
      <div className="text-[9px] text-muted-foreground p-2 leading-relaxed border border-border/30 rounded">
        ...
        <p>
          Use the AI bar at the top to generate effects, animations,
          transitions, and more with natural language.
        </p>
      </div>
    </div>
  );
...
export default function MediaPanel({ state, dispatch }: MediaPanelProps) {
  ...
  const searchAssets = async (q?: string) => {
    ...
    try {
      const res = await fetch(
        `/api/assets/search?provider=${assetProvider}&q=${encodeURIComponent(query)}`,
      );
      if (!res.ok) {
  ...
  const [tplAspect, setTplAspect] = useState<
    "all" | "9:16" | "1:1" | "16:9" | "4:5" | "21:9"
  >("all");
  ...
  const filteredTemplates = useMemo(() => {
    ...
    return TEMPLATES.filter((tpl) => {
      if (tplAspect !== "all") {
        if (aspectLabelOf(tpl.canvasWidth, tpl.canvasHeight) !== tplAspect)
          return false;
      }
      if (!q) return true;
      return (
  ...
  const [textPresetCategory, setTextPresetCategory] = useState<
    TextPresetCategory | "All"
  >("All");
  const filteredTextPresets: TextPreset[] =
    textPresetCategory === "All"
      ? ALL_TEXT_PRESETS
    ...
    >
      ...
      {activeTab === "media" && (
        <div className="flex flex-col flex-1 overflow-hidden">
          <div className="p-2 space-y-1.5 min-h-[90%]">
            <Button
              size="sm"
              variant="default"
          ...
          <div className="flex flex-wrap gap-1">
            {(["All", ...TEXT_PRESET_CATEGORIES] as const).map((c) => (
              <button
                key={c}
                onClick={() =>
                  setTextPresetCategory(c as TextPresetCategory | "All")
                }
                className={cn(
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
          <div className="p-2 space-y-2 border-b border-border">
            ...
            <p className="text-[10px] text-muted-foreground leading-snug">
              ...
              {assetProvider === "giphy" &&
                " Requires GIPHY_API_KEY on the server."}
      ...
      {activeTab === "templates" && (
        <div className="flex flex-col flex-1 overflow-y-auto p-2 space-y-2">
          ...
          <p className="text-[10px] text-muted-foreground leading-relaxed">
            Start from a ready-made layout. This{" "}
            <strong>replaces your current timeline</strong> — your imported
            media stays in the library so you can drop it into the empty slots.
          </p>
          <Input
            value={tplSearch}
            onChange={(e) => {
          ...
          />
          <div className="flex flex-wrap gap-1">
            {(["all", "9:16", "1:1", "16:9", "4:5", "21:9"] as const).map(
              (a) => (
                <button
                  key={a}
                  onClick={() => {
          ...
          <p className="text-[10px] text-muted-foreground">
            {filteredTemplates.length.toLocaleString()} match
            {filteredTemplates.length === 1 ? "" : "es"}
          ...
          <div className="space-y-1.5">
            {visibleTemplates.map((tpl) => {
              ...
              const aspectLabel =
                a === "other" ? `${tpl.canvasWidth}×${tpl.canvasHeight}` : a;
              return (
                <button
                  key={tpl.key}
                  ...
                  onClick={() => {
                    if (state.clips.length > 0) {
                      const ok = window.confirm(
                        `Apply "${tpl.name}" template? This will replace your current timeline (your media library is kept).`,
                      );
                      if (!ok) return;
                    }
                    dispatch({
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 space-y-0.5">
                    ...
                    <div className="flex items-center gap-1.5 text-[9px] text-muted-foreground">
                      <span className="px-1 py-px rounded bg-white/5">
                        {aspectLabel}
                      </span>
                      <span>·</span>
          ...
          {filteredTemplates.length > visibleTemplates.length ? (
            ...
            >
              Load more ({filteredTemplates.length - visibleTemplates.length}{" "}
              left)
            </Button>
          ) : null}
      ...
      {activeTab === "gallery" && gallerySubTab === "saved" && (
        <div className="flex flex-col flex-1 overflow-y-auto p-2 space-y-2">
          ...
          <p className="text-[10px] text-muted-foreground leading-snug">
            Save styling from any selected clip in the inspector's "Saved
            Presets" section. Click a preset here to add a fresh clip pre-styled
            with that look.
          </p>
          {presets.length === 0 ? (
